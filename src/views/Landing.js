              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    La retinopatía del prematuro es un trastorno ocular causado por el crecimiento anómalo de los vasos
                    sanguíneos en la parte sensible a la luz de los ojos (retina) de los bebés prematuros.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <p className="text-lg leading-relaxed m-4 text-gray-600">
                  Madres que tienen niños con esta enfermedad y están en seguimiento.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap">
